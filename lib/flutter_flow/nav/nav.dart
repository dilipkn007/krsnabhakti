...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => SearchPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => SearchPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BooklistWidget.routeName,
          path: BooklistWidget.routePath,
          builder: (context, params) => BooklistWidget(),
        ),
        FFRoute(
          name: BookReadingCopyCopyWidget.routeName,
          path: BookReadingCopyCopyWidget.routePath,
          builder: (context, params) => BookReadingCopyCopyWidget(),
        ),
        FFRoute(
